      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid">
	        ...
	        <h2 class="text-center">Ajouter Catalogue</h2>
	        <div class="container-fluid" style="margin-top: 20px;">
			    <div class="row justify-content-center"> <!-- Center the row horizontally -->
			        <div class="col-md-8"> <!-- Adjust the width of the form -->
			            <form id="addCatalogueForm" class="row g-3 needs-validation" action="<%=request.getContextPath()%>/insertCatalogue" method="post" novalidate>
			                <div class="col-md-6" style="margin-top: 20px;">
			                    <label for="validationCustomNomC" class="form-label">Nom Catalogue</label>
			                    <input type="text" class="form-control" id="validationCustomNomC" name="nomC" required>
			                    <div class="invalid-feedback">
			                        Veuillez fournir un nom de catalogue valide.
			                    </div>
			                </div>
			
			                <!-- Add other fields for the catalogue as needed -->
			
			                <div class="col-md-12" style="margin-top: 5%;">
			                    <!-- Add a new row for the "Ajouter Catalogue" button -->
			                    <button class="btn btn-primary col-12" type="submit">Ajouter Catalogue</button>
			                </div>
			            </form>
			        </div>
			    </div>
		...
		<script>
		    $(document).ready(function () {
		        // Fetch the form for adding a new catalogue
		        const addCatalogueForm = $('#addCatalogueForm');
		
		        // Prevent submission and apply custom Bootstrap validation styles
		        addCatalogueForm.on('submit', function (event) {
		            if (!addCatalogueForm[0].checkValidity()) {
		                event.preventDefault();
		                event.stopPropagation();
		            }
		
		            addCatalogueForm.addClass('was-validated');
		        });
		    });
		</script>
