          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                ...
                <h2 class="text-center">Ajouter Un Rayon</h2>
        
    <!-- Formulaire pour ajouter un rayon -->
    <div class="container-fluid" style="margin-top: 20px;">
        <form id="addRayonForm" class="row g-3 needs-validation" action="<%=request.getContextPath()%>/insertRayon" method="post" novalidate>
            <!-- Code -->
            ...
            <!-- Emplacement -->
            <div class="col-md-6" style="margin-top: 20px;">
                <label for="validationCustomEmplacement" class="form-label">Emplacement</label>
                <input type="text" class="form-control" id="validationCustomEmplacement" name="emplacement" required>
                <div class="invalid-feedback">
                    Veuillez fournir un emplacement valide.
                </div>
            </div>
            ...
            <div class="col-md-12" style="margin-top: 5%;">
                <button class="btn btn-primary col-12" type="submit">Ajouter Rayon</button>
            </div>
        </form>
    </div>

    <!-- Vos scripts JavaScript pour la validation du formulaire, etc. -->

    <!-- Scripts, inclusions, etc. -->
